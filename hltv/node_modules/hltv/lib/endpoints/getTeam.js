...
exports.getTeam = function (config) { return function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var t$, e$, name, logo, coverImage, location, facebook, twitter, rank, regularPlayers, officialPicturePlayers, players, recentResults, rankingDevelopment, rankings, bigAchievements, events;
            ...
            switch (_b.label) {
                ...
                case 2:
                    ...
                    rank = Number(t$('.profile-team-stat .right')
                        ...
                        .text()
                        .replace('#', '')) || undefined;
                    regularPlayers = mappers_1.toArray(t$('.overlayImageFrame-square'))
                    ...
                    officialPicturePlayers = mappers_1.toArray(t$('.overlayImageFrame'))
                        .filter(parsing_1.hasChild('.playerFlagName .text-ellipsis'))
                        .map(function (playerEl) { return ({
                        name: playerEl.find('.playerFlagName .text-ellipsis').text(),
                        id: Number(parsing_1.popSlashSource(playerEl.find('.bodyshot-team-img')).split('.')[0])
                    }); });
                    players = regularPlayers.concat(officialPicturePlayers);
