...
module CounterRecord
  module Relations
    ...
    module ClassMethods
      ...
      def has_many(name, class_name: nil, foreign_key: "#{table_name.singularize}_id", **_options)
        super
        add_relation(name, type: :has_many, class_name: class_name, foreign_key: foreign_key)
      ...
      def add_relation(name, type:, class_name:, foreign_key: nil, polymorphic: false)
